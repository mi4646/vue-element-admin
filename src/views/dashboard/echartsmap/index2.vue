    ...
    mapChart(divid) {
      axios.get('/js/map/' + chinaId + '.json', {}).then(response => {
        ...
        myChart.on('click', function(param) {
          console.log('cityId param', param)
          ...
          if (cityId) {
            ...
            axios.get('/js/map/' + param.name + '.json', function(mapJson, status) {
              registerAndSetOption(myChart, param.data.id, 'ISD', mapJson, true)
            }).fail(function() {
